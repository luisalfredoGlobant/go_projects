...
INSERT INTO product (id, name, supplier_id, category_id, units_in_stock, unit_price, discontinued)
VALUES (1, 'carreola', 123, 12, 25, 12000.34, FALSE),
       (2, 'mamila', 124, 34, 1, 122.34, FALSE);